...
class EducationalTutorAgent:
    ...
    def _build_workflow(self) -> StateGraph:
        ...
        workflow.add_node("similar_questions", self._similar_questions_node)
        ...
        # Add regular edges
        workflow.add_edge("evaluation", "similar_questions")
        workflow.add_edge("solve", "similar_questions")
        workflow.add_edge("similar_questions", "final_output_assembler")
